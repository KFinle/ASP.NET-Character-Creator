        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    maxAP = table.Column<int>(nullable: false),
                    ...
                    expToNextLevel = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    skillDesc = table.Column<string>(nullable: false),
                    skillType = table.Column<int>(nullable: false),
                    apCost = table.Column<int>(nullable: false),
                    abilityDmg = table.Column<float>(nullable: false),
                    dmgType = table.Column<int>(nullable: false),
                    critMultiplier = table.Column<float>(nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Jobs",
                columns: new[] { "JobId", "JobName", "Role" },
                values: new object[,]
                {
                    { 1, "Warrior", 0 },
                    { 2, "Paladin", 0 },
